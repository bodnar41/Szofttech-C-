...
void init_entities(World* world) {
	...
	//Trees
/*	load_model("objects//tree.obj", &world->tree1.model);
	world->tree1.texture = load_texture("textures//leaves.jpg");
	
	load_model("objects//tree.obj", &world->tree2.model);
	world->tree2.texture = load_texture("textures//leaves.jpg");

	load_model("objects//tree.obj", &world->tree3.model);
	world->tree3.texture = load_texture("textures//leaves.jpg");
	
	load_model("objects//tree.obj", &world->tree4.model);
	world->tree4.texture = load_texture("textures//leaves.jpg");
	
	load_model("objects//tree.obj", &world->tree5.model);
	world->tree5.texture = load_texture("textures//leaves.jpg");
	
	load_model("objects//tree.obj", &world->tree6.model);
	world->tree6.texture = load_texture("textures//leaves.jpg");
